...
import {
  ...
  intStorageSlotDiffLatestStateServiceGet,
  intStorageSlotDiffLatestStateServiceList,
  ...
  intStorageSlotLatestStateServiceGet,
  intStorageSlotLatestStateServiceList,
  ...
  intStorageSlotReadByAddressSlotServiceGet,
  intStorageSlotReadByAddressSlotServiceList,
...
import type {
  ...
  IntStorageSlotDiffLatestStateServiceGetError,
  IntStorageSlotDiffLatestStateServiceGetResponse,
  IntStorageSlotDiffLatestStateServiceListData,
  IntStorageSlotDiffLatestStateServiceListError,
  IntStorageSlotDiffLatestStateServiceListResponse,
  ...
  IntStorageSlotLatestStateServiceGetError,
  IntStorageSlotLatestStateServiceGetResponse,
  IntStorageSlotLatestStateServiceListData,
  IntStorageSlotLatestStateServiceListError,
  IntStorageSlotLatestStateServiceListResponse,
  ...
  IntStorageSlotReadByAddressSlotServiceGetError,
  IntStorageSlotReadByAddressSlotServiceGetResponse,
  IntStorageSlotReadByAddressSlotServiceListData,
  IntStorageSlotReadByAddressSlotServiceListError,
  IntStorageSlotReadByAddressSlotServiceListResponse,
...
export const intStorageSlotDiffLatestStateServiceListQueryKey = (
  options?: Options<IntStorageSlotDiffLatestStateServiceListData>
) => createQueryKey('intStorageSlotDiffLatestStateServiceList', options);
 ...
 * Retrieve paginated results with optional filtering
 */
export const intStorageSlotDiffLatestStateServiceListOptions = (
  options?: Options<IntStorageSlotDiffLatestStateServiceListData>
) =>
  queryOptions<
    IntStorageSlotDiffLatestStateServiceListResponse,
    IntStorageSlotDiffLatestStateServiceListError,
    IntStorageSlotDiffLatestStateServiceListResponse,
    ReturnType<typeof intStorageSlotDiffLatestStateServiceListQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await intStorageSlotDiffLatestStateServiceList({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: intStorageSlotDiffLatestStateServiceListQueryKey(options),
  });

export const intStorageSlotDiffLatestStateServiceGetQueryKey = (
  options: Options<IntStorageSlotDiffLatestStateServiceGetData>
) => createQueryKey('intStorageSlotDiffLatestStateServiceGet', options);
 ...
 * Retrieve a single record by address
 */
export const intStorageSlotDiffLatestStateServiceGetOptions = (
  options: Options<IntStorageSlotDiffLatestStateServiceGetData>
) =>
  queryOptions<
    IntStorageSlotDiffLatestStateServiceGetResponse,
    IntStorageSlotDiffLatestStateServiceGetError,
    IntStorageSlotDiffLatestStateServiceGetResponse,
    ReturnType<typeof intStorageSlotDiffLatestStateServiceGetQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await intStorageSlotDiffLatestStateServiceGet({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: intStorageSlotDiffLatestStateServiceGetQueryKey(options),
  });
...
export const intStorageSlotLatestStateServiceListQueryKey = (
  options?: Options<IntStorageSlotLatestStateServiceListData>
) => createQueryKey('intStorageSlotLatestStateServiceList', options);
 ...
 * Retrieve paginated results with optional filtering
 */
export const intStorageSlotLatestStateServiceListOptions = (
  options?: Options<IntStorageSlotLatestStateServiceListData>
) =>
  queryOptions<
    IntStorageSlotLatestStateServiceListResponse,
    IntStorageSlotLatestStateServiceListError,
    IntStorageSlotLatestStateServiceListResponse,
    ReturnType<typeof intStorageSlotLatestStateServiceListQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await intStorageSlotLatestStateServiceList({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: intStorageSlotLatestStateServiceListQueryKey(options),
  });

export const intStorageSlotLatestStateServiceGetQueryKey = (
  options: Options<IntStorageSlotLatestStateServiceGetData>
) => createQueryKey('intStorageSlotLatestStateServiceGet', options);
 ...
 * Retrieve a single record by address
 */
export const intStorageSlotLatestStateServiceGetOptions = (options: Options<IntStorageSlotLatestStateServiceGetData>) =>
  queryOptions<
    IntStorageSlotLatestStateServiceGetResponse,
    IntStorageSlotLatestStateServiceGetError,
    IntStorageSlotLatestStateServiceGetResponse,
    ReturnType<typeof intStorageSlotLatestStateServiceGetQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await intStorageSlotLatestStateServiceGet({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: intStorageSlotLatestStateServiceGetQueryKey(options),
  });
...
export const intStorageSlotReadByAddressSlotServiceListQueryKey = (
  options?: Options<IntStorageSlotReadByAddressSlotServiceListData>
) => createQueryKey('intStorageSlotReadByAddressSlotServiceList', options);
 ...
 * Retrieve paginated results with optional filtering
 */
export const intStorageSlotReadByAddressSlotServiceListOptions = (
  options?: Options<IntStorageSlotReadByAddressSlotServiceListData>
) =>
  queryOptions<
    IntStorageSlotReadByAddressSlotServiceListResponse,
    IntStorageSlotReadByAddressSlotServiceListError,
    IntStorageSlotReadByAddressSlotServiceListResponse,
    ReturnType<typeof intStorageSlotReadByAddressSlotServiceListQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await intStorageSlotReadByAddressSlotServiceList({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: intStorageSlotReadByAddressSlotServiceListQueryKey(options),
  });

export const intStorageSlotReadByAddressSlotServiceGetQueryKey = (
  options: Options<IntStorageSlotReadByAddressSlotServiceGetData>
) => createQueryKey('intStorageSlotReadByAddressSlotServiceGet', options);
 ...
 * Retrieve a single record by address
 */
export const intStorageSlotReadByAddressSlotServiceGetOptions = (
  options: Options<IntStorageSlotReadByAddressSlotServiceGetData>
) =>
  queryOptions<
    IntStorageSlotReadByAddressSlotServiceGetResponse,
    IntStorageSlotReadByAddressSlotServiceGetError,
    IntStorageSlotReadByAddressSlotServiceGetResponse,
    ReturnType<typeof intStorageSlotReadByAddressSlotServiceGetQueryKey>
  >({
    queryFn: async ({ queryKey, signal }) => {
      const { data } = await intStorageSlotReadByAddressSlotServiceGet({
        ...options,
        ...queryKey[0],
        signal,
        throwOnError: true,
    ...
    queryKey: intStorageSlotReadByAddressSlotServiceGetQueryKey(options),
  });
