/**
 * BeaconchainIcon component displays the Beaconcha.in logo
 */
export function BeaconchainIcon({ className = 'h-5 w-5' }: { className?: string }): React.JSX.Element {
  return (
    <svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Beaconcha.in">
      <defs>
        <clipPath id="beaconchain-circle">
      ...
      <style>
        {`
          ...
          [data-theme="dark"] .beaconchain-bg {
            fill: #fff;
          }
          [data-theme="dark"] .beaconchain-fg {
            fill: #1e1c1f;
          }
        `}
      </style>
      <g clipPath="url(#beaconchain-circle)">
        <rect className="beaconchain-bg" x="-14.88" y="-19.92" width="149.75" height="146.77" />
        <path
          className="beaconchain-fg"
