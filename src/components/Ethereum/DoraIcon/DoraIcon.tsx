/**
 * DoraIcon component displays the Dora block explorer logo
 * Dora uses the same Beaconcha.in branding
 */
export function DoraIcon({ className = 'h-5 w-5' }: { className?: string }): React.JSX.Element {
  return (
    <svg viewBox="0 0 120 120" xmlns="http://www.w3.org/2000/svg" className={className} aria-label="Dora">
      <defs>
        <clipPath id="dora-circle">
      ...
      <style>
        {`
          ...
          [data-theme="dark"] .dora-bg {
            fill: #fff;
          }
          [data-theme="dark"] .dora-fg {
            fill: #1e1c1f;
          }
        `}
      </style>
      <g clipPath="url(#dora-circle)">
        <rect className="dora-bg" x="-14.88" y="-19.92" width="149.75" height="146.77" />
        <path
          className="dora-fg"
