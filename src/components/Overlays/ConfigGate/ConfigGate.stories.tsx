...
const meta: Meta = {
  title: 'Components/Overlays/ConfigGate',
    ...
    <ConfigGate>
      <div className="flex min-h-screen items-center justify-center bg-background">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-foreground">App Loaded Successfully</h1>
...
export const Loading: Story = {
  ...
  render: () => (
    <ConfigGate>
      <div className="flex min-h-screen items-center justify-center bg-background">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-foreground">This should not be visible</h1>
        </div>
      </div>
    </ConfigGate>
  ),
