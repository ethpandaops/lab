...
//
// IntAddressLastAccessService provides RPC methods for querying int_address__last_access data
type IntAddressLastAccessServiceClient interface {
	// List returns paginated int_address__last_access records
	List(ctx context.Context, in *ListIntAddressLastAccessRequest, opts ...grpc.CallOption) (*ListIntAddressLastAccessResponse, error)
	// Get returns a single int_address__last_access record by primary key
...
var IntAddressLastAccessService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "vendor/xatu-cbt/clickhouse/int_address__last_access.proto",
}
