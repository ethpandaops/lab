...
// @generated from file vendor/xatu-cbt/clickhouse/int_block_proposer__canonical.proto (package cbt, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class ListIntBlockProposerCanonicalResponse extends Message<ListIntBlockProposerCanonicalResponse> {
   ...
   *
   * @generated from field: repeated cbt.IntBlockProposerCanonical int_block_proposer__canonical = 1;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "int_block_proposer__canonical", kind: "message", T: IntBlockProposerCanonical, repeated: true },
