...
// @generated from file vendor/xatu-cbt/clickhouse/int_block_proposer__head.proto (package cbt, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class ListIntBlockProposerHeadResponse extends Message<ListIntBlockProposerHeadResponse> {
   ...
   *
   * @generated from field: repeated cbt.IntBlockProposerHead int_block_proposer__head = 1;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "int_block_proposer__head", kind: "message", T: IntBlockProposerHead, repeated: true },
