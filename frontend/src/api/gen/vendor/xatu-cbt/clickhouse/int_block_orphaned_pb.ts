...
// @generated from file vendor/xatu-cbt/clickhouse/int_block_orphaned.proto (package cbt, syntax proto3)
/* eslint-disable */
// @ts-nocheck
...
export class ListIntBlockOrphanedResponse extends Message<ListIntBlockOrphanedResponse> {
   ...
   *
   * @generated from field: repeated cbt.IntBlockOrphaned int_block_orphaned = 1;
   */
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "int_block_orphaned", kind: "message", T: IntBlockOrphaned, repeated: true },
