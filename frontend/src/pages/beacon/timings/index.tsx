...
function BeaconChainTimings() {
  ...
  return (
    <div className="space-y-6">
      <AboutThisData>
        <p>
          The Beacon Chain is the consensus layer of Ethereum, responsible for coordinating the
          network of validators. Here we analyze various metrics about block timing, network
          performance, and consensus health.
        </p>
      </AboutThisData>
          ...
          >
            <div className="flex gap-6 items-start">
              ...
              <div className="flex flex-col flex-grow">
                <h3 className="text-xl font-sans font-bold text-primary group-hover:text-accent transition-colors">
                  Block Timings
                </h3>
                <p className="text-sm font-mono text-secondary">
                  Analyze block arrival times and network performance
                </p>
              </div>
            </div>
