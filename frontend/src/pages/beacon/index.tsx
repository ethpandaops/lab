          ...
          >
            <div className="flex gap-6 items-start">
              ...
              <div className="flex flex-col flex-grow">
                <h3 className="text-xl font-sans font-bold text-cyber-neon group-hover:text-cyber-blue transition-colors">Live View</h3>
                <p className="text-sm font-mono text-cyber-neon/85">Watch slots as they happen in real-time</p>
              </div>
            </div>
