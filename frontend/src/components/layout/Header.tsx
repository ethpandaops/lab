      ...
      <div className="h-16 px-4 sm:px-6 lg:px-8">
        <div className="flex h-full items-center justify-between">
          <div className="flex items-center">
            <button type="button" className="text-tertiary hover:text-gray-600 lg:hidden" onClick={onToggleSidebar}>
            ...
            <Link to="/" className="flex items-center space-x-3">
              ...
              <div className="hidden lg:block">
                <h1 className="text-2xl font-bold text-gray-900 dark:text-primary">ethPandaOps Lab</h1>
              </div>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              <span className={`inline-block w-2 h-2 rounded-full ${useRestApi ? 'bg-green-500' : 'bg-blue-500'}`} />
