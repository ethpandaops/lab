    ...
    >
      <div className="w-full max-w-2xl mx-auto h-full flex flex-col justify-center relative">
        ...
        <div className="absolute top-1/2 -left-40 w-40 h-2 bg-gradient-to-r from-orange-500/0 to-orange-500/70 transform -translate-y-20 z-10 overflow-hidden">
          <div className="flow-dot-left absolute top-0 right-0 h-full w-8 bg-orange-400/80 rounded-full" style={{ animationDelay: '0s' }}></div>
          <div className="flow-dot-left absolute top-0 right-0 h-full w-8 bg-orange-400/80 rounded-full" style={{ animationDelay: '1.5s' }}></div>
        </div>
        <div className="absolute top-1/2 -left-50 w-50 h-2 bg-gradient-to-r from-green-500/0 to-green-500/70 transform translate-y-10 z-10 overflow-hidden">
          <div className="flow-dot-left absolute top-0 right-0 h-full w-8 bg-green-400/80 rounded-full" style={{ animationDelay: '0.5s' }}></div>
          <div className="flow-dot-left absolute top-0 right-0 h-full w-8 bg-green-400/80 rounded-full" style={{ animationDelay: '2s' }}></div>
        </div>
        ...
        <div className="absolute top-1/2 -right-40 w-40 h-2 bg-gradient-to-l from-purple-500/0 to-purple-500/70 transform -translate-y-20 z-10 overflow-hidden">
          <div className="flow-dot-right absolute top-0 left-0 h-full w-8 bg-purple-400/80 rounded-full" style={{ animationDelay: '0.7s' }}></div>
          <div className="flow-dot-right absolute top-0 left-0 h-full w-8 bg-purple-400/80 rounded-full" style={{ animationDelay: '2.2s' }}></div>
        </div>
        <div className="absolute top-1/2 -right-50 w-50 h-2 bg-gradient-to-l from-indigo-500/0 to-indigo-500/70 transform translate-y-10 z-10 overflow-hidden">
          <div className="flow-dot-right absolute top-0 left-0 h-full w-8 bg-indigo-400/80 rounded-full" style={{ animationDelay: '1.2s' }}></div>
          <div className="flow-dot-right absolute top-0 left-0 h-full w-8 bg-indigo-400/80 rounded-full" style={{ animationDelay: '2.7s' }}></div>
        </div>
          ...
          <div className="p-4 border-b border-white/5 flex items-center justify-between">
            ...
            {block_value !== undefined && (
              <div className="px-2.5 py-1 bg-green-500/10 border border-green-500/20 rounded-md text-green-400 text-sm font-mono flex items-center">
                <svg className="w-3 h-3 mr-1 text-green-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="flex justify-between items-center p-3 border-b border-white/5">
                <div className="flex items-center">
                  <div className="w-5 h-5 bg-amber-500/10 rounded-sm flex items-center justify-center mr-2">
                    <svg className="w-3 h-3 text-amber-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {blobsCount > 0 && (
              <div className="bg-purple-900/10 border border-purple-500/10 rounded-lg overflow-hidden mb-3">
                <div className="flex justify-between items-center p-3 border-b border-purple-500/10">
                  ...
                  <span className="text-xs text-purple-300/40 font-mono">{blobsCount} blob{blobsCount !== 1 ? 's' : ''}</span>
                </div>
