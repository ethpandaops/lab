...
export const TimingsView: React.FC<TimingsViewProps> = ({ bids, relayColors, className }) => {
          ...
          <CardBody>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm font-mono text-secondary">
                  {bidTimeMetrics.first
                    ? `${(bidTimeMetrics.first.time / 1000).toFixed(2)}s`
                    : 'N/A'}
                </span>
              </div>
              <div className="flex flex-col">
                ...
                return (
                  <div key={relayName} className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      {winningBid && <span className="text-xs font-mono text-success">Winner</span>}
                    </div>
                  </div>
                );
              })}
