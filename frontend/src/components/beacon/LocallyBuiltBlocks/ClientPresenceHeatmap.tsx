...
export const ClientPresenceHeatmap: FC<ClientPresenceHeatmapProps> = ({ data, isLoading }) => {
  ...
  const presenceData = useMemo(() => {
    ...
    const clients = clientType === 'execution' ? EXECUTION_CLIENTS : CONSENSUS_CLIENTS;
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative">
        {/* Tooltip */}
        {hoveredCell && (
          <div className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-surface/90 backdrop-blur-sm border border-subtle px-3 py-1.5 rounded-md text-xs font-mono text-primary z-10 whitespace-nowrap">
