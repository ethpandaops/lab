...
export const BlocksTimeline: FC<BlocksTimelineProps> = ({
  data,
  isLoading,
  onSelectBlock
}) => {
            ...
            >
              ...
              <div className="mt-3 bg-surface/50 backdrop-blur-sm p-3 rounded-lg border border-subtle/30 space-y-2">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <div className="text-xs font-mono text-secondary">{block.metadata?.metaClientName || 'Unknown'}</div>
                    <div className="text-xs font-mono text-tertiary">{block.metadata?.metaClientImplementation || ''}</div>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    <div className="text-xs font-mono text-secondary">{block.executionPayloadTransactionsCount} txs</div>
                    <div className="text-xs font-mono text-tertiary">{formatBytes(block.executionPayloadTransactionsTotalBytes)}</div>
                  </div>
                </div>
