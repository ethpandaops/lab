      ...
      <div className="p-6 space-y-4">
        ...
        <div className="space-y-4 font-sans text-sm text-tertiary">
          <div>
            ...
            <p>
              Shows when attestations are first observed across the network. Each point represents
              the number of unique validators whose attestation for this block was first seen by any
              of our monitoring nodes in that time window.
            </p>
          </div>
          <div>
            <h4 className="font-sans font-medium text-primary mb-1">Cumulative Distribution</h4>
            <p>
              Shows the total percentage of attestations received over time. The dashed line at 66%
              represents the target threshold for consensus.
            </p>
          </div>
        </div>
      </div>,
          ...
          {loading ? (
            ...
            <div className="flex items-center gap-4 mt-2 md:mt-0">
              <div className="flex items-baseline gap-1 font-mono">
                ...
                <span className="text-tertiary/70 text-[9px]">
                  / {maxPossibleValidators.toLocaleString()}
                </span>
              ...
              <div className="relative h-1 w-32 rounded-full overflow-hidden bg-base/20 ring-1 ring-inset ring-white/5">
                ...
                <div
                  className={`absolute inset-y-0 left-0 transition-all duration-100 ${
                    currentAttestationCount >= attestationThreshold ? 'bg-success' : 'bg-success/40'
                  }`}
