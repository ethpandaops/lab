      ...
      <div className="relative p-4 sm:p-6">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <div className="h-10 w-10 sm:h-12 sm:w-12 rounded-xl bg-cyan-400/20 p-2 sm:p-2.5 flex items-center justify-center ring-1 ring-cyan-400/30 shadow-[0_0_15px_-3px_rgba(6,182,212,0.4)]">
            <Share2 className="h-5 w-5 sm:h-6 sm:w-6 text-accent-secondary" />
          </div>
          <div className="flex-1 min-w-0">
            ...
            <p className="mt-1 text-sm sm:text-base text-primary">{description}</p>
          </div>
          <Link
            to={buttonLink}
            className="w-full sm:w-auto flex-shrink-0 inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-primary bg-gradient-to-r from-cyan-500/20 to-purple-500/20 hover:from-cyan-500/30 hover:to-purple-500/30 border border-cyan-400/50 rounded-lg transition-all hover:scale-105 shadow-[0_0_15px_-3px_rgba(6,182,212,0.3)]"
          >
            {buttonText}
