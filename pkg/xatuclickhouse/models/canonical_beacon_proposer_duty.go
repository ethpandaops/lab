...
// CanonicalBeaconProposerDuty represents a row from the canonical_beacon_proposer_duty table.
type CanonicalBeaconProposerDuty struct {
    ...
    ProposerValidatorIndex    uint32    `db:"proposer_validator_index" json:"proposer_validator_index"`
...
// TableName returns the table name for CanonicalBeaconProposerDuty.
func (m *CanonicalBeaconProposerDuty) TableName() string {
    return "canonical_beacon_proposer_duty"
}

// CanonicalBeaconProposerDutyParams represents query parameters for the canonical_beacon_proposer_duty table.
