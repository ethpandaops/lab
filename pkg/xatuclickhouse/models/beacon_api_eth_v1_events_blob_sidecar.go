...
// BeaconApiEthV1EventsBlobSidecar represents a row from the beacon_api_eth_v1_events_blob_sidecar table.
...
// TableName returns the table name for BeaconApiEthV1EventsBlobSidecar.
func (m *BeaconApiEthV1EventsBlobSidecar) TableName() string {
    return "beacon_api_eth_v1_events_blob_sidecar"
}

// BeaconApiEthV1EventsBlobSidecarParams represents query parameters for the beacon_api_eth_v1_events_blob_sidecar table.
