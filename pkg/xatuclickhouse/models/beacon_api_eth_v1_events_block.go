...
// BeaconApiEthV1EventsBlock represents a row from the beacon_api_eth_v1_events_block table.
...
// TableName returns the table name for BeaconApiEthV1EventsBlock.
func (m *BeaconApiEthV1EventsBlock) TableName() string {
    return "beacon_api_eth_v1_events_block"
}

// BeaconApiEthV1EventsBlockParams represents query parameters for the beacon_api_eth_v1_events_block table.
