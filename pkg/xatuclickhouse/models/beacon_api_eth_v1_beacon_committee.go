...
// BeaconApiEthV1BeaconCommittee represents a row from the beacon_api_eth_v1_beacon_committee table.
...
// TableName returns the table name for BeaconApiEthV1BeaconCommittee.
func (m *BeaconApiEthV1BeaconCommittee) TableName() string {
    return "beacon_api_eth_v1_beacon_committee"
}

// BeaconApiEthV1BeaconCommitteeParams represents query parameters for the beacon_api_eth_v1_beacon_committee table.
