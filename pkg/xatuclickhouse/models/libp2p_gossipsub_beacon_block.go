...
// Libp2pGossipsubBeaconBlock represents a row from the libp2p_gossipsub_beacon_block table.
...
// TableName returns the table name for Libp2pGossipsubBeaconBlock.
func (m *Libp2pGossipsubBeaconBlock) TableName() string {
    return "libp2p_gossipsub_beacon_block"
}

// Libp2pGossipsubBeaconBlockParams represents query parameters for the libp2p_gossipsub_beacon_block table.
