...
// CanonicalExecutionNonceReads represents a row from the canonical_execution_nonce_reads table.
...
// TableName returns the table name for CanonicalExecutionNonceReads.
func (m *CanonicalExecutionNonceReads) TableName() string {
    return "canonical_execution_nonce_reads"
}

// CanonicalExecutionNonceReadsParams represents query parameters for the canonical_execution_nonce_reads table.
