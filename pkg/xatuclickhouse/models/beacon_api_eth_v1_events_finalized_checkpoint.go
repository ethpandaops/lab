...
// BeaconApiEthV1EventsFinalizedCheckpoint represents a row from the beacon_api_eth_v1_events_finalized_checkpoint table.
...
// TableName returns the table name for BeaconApiEthV1EventsFinalizedCheckpoint.
func (m *BeaconApiEthV1EventsFinalizedCheckpoint) TableName() string {
    return "beacon_api_eth_v1_events_finalized_checkpoint"
}

// BeaconApiEthV1EventsFinalizedCheckpointParams represents query parameters for the beacon_api_eth_v1_events_finalized_checkpoint table.
