...
// BeaconApiEthV1EventsChainReorg represents a row from the beacon_api_eth_v1_events_chain_reorg table.
type BeaconApiEthV1EventsChainReorg struct {
    ...
    Depth    uint32    `db:"depth" json:"depth"`
    OldHeadBlock    string    `db:"old_head_block" json:"old_head_block"`
    NewHeadBlock    string    `db:"new_head_block" json:"new_head_block"`
    OldHeadState    string    `db:"old_head_state" json:"old_head_state"`
    NewHeadState    string    `db:"new_head_state" json:"new_head_state"`
...
// TableName returns the table name for BeaconApiEthV1EventsChainReorg.
func (m *BeaconApiEthV1EventsChainReorg) TableName() string {
    return "beacon_api_eth_v1_events_chain_reorg"
}

// BeaconApiEthV1EventsChainReorgParams represents query parameters for the beacon_api_eth_v1_events_chain_reorg table.
