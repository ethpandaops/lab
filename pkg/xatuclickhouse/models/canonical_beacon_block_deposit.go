...
// CanonicalBeaconBlockDeposit represents a row from the canonical_beacon_block_deposit table.
type CanonicalBeaconBlockDeposit struct {
    ...
    DepositProof    []string    `db:"deposit_proof" json:"deposit_proof"`
    DepositDataPubkey    string    `db:"deposit_data_pubkey" json:"deposit_data_pubkey"`
    DepositDataWithdrawalCredentials    string    `db:"deposit_data_withdrawal_credentials" json:"deposit_data_withdrawal_credentials"`
    DepositDataAmount    string    `db:"deposit_data_amount" json:"deposit_data_amount"`
    DepositDataSignature    string    `db:"deposit_data_signature" json:"deposit_data_signature"`
...
// TableName returns the table name for CanonicalBeaconBlockDeposit.
func (m *CanonicalBeaconBlockDeposit) TableName() string {
    return "canonical_beacon_block_deposit"
}

// CanonicalBeaconBlockDepositParams represents query parameters for the canonical_beacon_block_deposit table.
