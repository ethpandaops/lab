...
// CanonicalExecutionBalanceDiffs represents a row from the canonical_execution_balance_diffs table.
...
// TableName returns the table name for CanonicalExecutionBalanceDiffs.
func (m *CanonicalExecutionBalanceDiffs) TableName() string {
    return "canonical_execution_balance_diffs"
}

// CanonicalExecutionBalanceDiffsParams represents query parameters for the canonical_execution_balance_diffs table.
