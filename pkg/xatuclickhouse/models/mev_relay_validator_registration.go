...
// MevRelayValidatorRegistration represents a row from the mev_relay_validator_registration table.
...
// TableName returns the table name for MevRelayValidatorRegistration.
func (m *MevRelayValidatorRegistration) TableName() string {
    return "mev_relay_validator_registration"
}

// MevRelayValidatorRegistrationParams represents query parameters for the mev_relay_validator_registration table.
