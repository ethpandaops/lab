...
// BeaconApiEthV1ValidatorAttestationData represents a row from the beacon_api_eth_v1_validator_attestation_data table.
type BeaconApiEthV1ValidatorAttestationData struct {
    ...
    RequestDateTime    time.Time    `db:"request_date_time" json:"request_date_time"`
    RequestDuration    uint32    `db:"request_duration" json:"request_duration"`
    RequestSlotStartDiff    uint32    `db:"request_slot_start_diff" json:"request_slot_start_diff"`
...
// TableName returns the table name for BeaconApiEthV1ValidatorAttestationData.
func (m *BeaconApiEthV1ValidatorAttestationData) TableName() string {
    return "beacon_api_eth_v1_validator_attestation_data"
}

// BeaconApiEthV1ValidatorAttestationDataParams represents query parameters for the beacon_api_eth_v1_validator_attestation_data table.
