...
// BeaconApiEthV1ProposerDuty represents a row from the beacon_api_eth_v1_proposer_duty table.
...
// TableName returns the table name for BeaconApiEthV1ProposerDuty.
func (m *BeaconApiEthV1ProposerDuty) TableName() string {
    return "beacon_api_eth_v1_proposer_duty"
}

// BeaconApiEthV1ProposerDutyParams represents query parameters for the beacon_api_eth_v1_proposer_duty table.
