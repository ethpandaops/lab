...
// CanonicalBeaconCommittee represents a row from the canonical_beacon_committee table.
...
// TableName returns the table name for CanonicalBeaconCommittee.
func (m *CanonicalBeaconCommittee) TableName() string {
    return "canonical_beacon_committee"
}

// CanonicalBeaconCommitteeParams represents query parameters for the canonical_beacon_committee table.
