...
// Libp2pGossipsubBeaconAttestation represents a row from the libp2p_gossipsub_beacon_attestation table.
...
// TableName returns the table name for Libp2pGossipsubBeaconAttestation.
func (m *Libp2pGossipsubBeaconAttestation) TableName() string {
    return "libp2p_gossipsub_beacon_attestation"
}

// Libp2pGossipsubBeaconAttestationParams represents query parameters for the libp2p_gossipsub_beacon_attestation table.
