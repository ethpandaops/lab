...
// CanonicalBeaconBlockBlsToExecutionChange represents a row from the canonical_beacon_block_bls_to_execution_change table.
type CanonicalBeaconBlockBlsToExecutionChange struct {
    ...
    ExchangingMessageValidatorIndex    uint32    `db:"exchanging_message_validator_index" json:"exchanging_message_validator_index"`
    ExchangingMessageFromBlsPubkey    string    `db:"exchanging_message_from_bls_pubkey" json:"exchanging_message_from_bls_pubkey"`
    ExchangingMessageToExecutionAddress    string    `db:"exchanging_message_to_execution_address" json:"exchanging_message_to_execution_address"`
    ExchangingSignature    string    `db:"exchanging_signature" json:"exchanging_signature"`
...
// TableName returns the table name for CanonicalBeaconBlockBlsToExecutionChange.
func (m *CanonicalBeaconBlockBlsToExecutionChange) TableName() string {
    return "canonical_beacon_block_bls_to_execution_change"
}

// CanonicalBeaconBlockBlsToExecutionChangeParams represents query parameters for the canonical_beacon_block_bls_to_execution_change table.
