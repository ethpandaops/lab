...
// CanonicalBeaconBlockWithdrawal represents a row from the canonical_beacon_block_withdrawal table.
type CanonicalBeaconBlockWithdrawal struct {
    ...
    WithdrawalIndex    uint32    `db:"withdrawal_index" json:"withdrawal_index"`
    WithdrawalValidatorIndex    uint32    `db:"withdrawal_validator_index" json:"withdrawal_validator_index"`
    WithdrawalAddress    string    `db:"withdrawal_address" json:"withdrawal_address"`
...
// TableName returns the table name for CanonicalBeaconBlockWithdrawal.
func (m *CanonicalBeaconBlockWithdrawal) TableName() string {
    return "canonical_beacon_block_withdrawal"
}

// CanonicalBeaconBlockWithdrawalParams represents query parameters for the canonical_beacon_block_withdrawal table.
