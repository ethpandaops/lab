...
var file_backend_pkg_server_proto_config_config_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x6d, 0x65, 0x6e, 0x74, 0x73, 0x22, 0x58, 0x0a, 0x10, 0x45, 0x78, 0x70, 0x65, 0x72,
	0x69, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x73, 0x18, 0x03, 0x20, 0x03, 0x28, 0x09, 0x52, 0x08, 0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
	0x73, 0x32, 0x51, 0x0a, 0x0d, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69,
...
var file_backend_pkg_server_proto_config_config_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_backend_pkg_server_proto_config_config_proto_goTypes = []any{
	...
	nil,                              // 15: config.EthereumConfig.NetworksEntry
	nil,                              // 16: config.NetworkConfig.ServiceUrlsEntry
	nil,                              // 17: config.ForkInfo.MinClientVersionsEntry
	nil,                              // 18: config.BeaconModule.NetworksEntry
}
var file_backend_pkg_server_proto_config_config_proto_depIdxs = []int32{
	...
	15, // 4: config.EthereumConfig.networks:type_name -> config.EthereumConfig.NetworksEntry
	16, // 5: config.NetworkConfig.service_urls:type_name -> config.NetworkConfig.ServiceUrlsEntry
	...
	17, // 9: config.ForkInfo.min_client_versions:type_name -> config.ForkInfo.MinClientVersionsEntry
	...
	18, // 13: config.BeaconModule.networks:type_name -> config.BeaconModule.NetworksEntry
	...
	11, // 16: config.BeaconModule.NetworksEntry.value:type_name -> config.BeaconNetworkConfig
