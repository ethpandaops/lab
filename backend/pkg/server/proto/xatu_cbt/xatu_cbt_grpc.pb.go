...
// UnimplementedXatuCBTServer must be embedded to have
...
func (UnimplementedXatuCBTServer) testEmbeddedByValue()                 {}
...
func RegisterXatuCBTServer(s grpc.ServiceRegistrar, srv XatuCBTServer) {
	// If the following call pancis, it indicates UnimplementedXatuCBTServer was
...
var XatuCBT_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "pkg/server/proto/xatu_cbt/xatu_cbt.proto",
}
