...
// ListIntBlockFirstSeenByNode mocks base method.
func (m *MockXatuCBTClient) ListIntBlockFirstSeenByNode(ctx context.Context, in *clickhouse.ListIntBlockFirstSeenByNodeRequest, opts ...grpc.CallOption) (*clickhouse.ListIntBlockFirstSeenByNodeResponse, error) {
	m.ctrl.T.Helper()
	varargs := []any{ctx, in}
	for _, a := range opts {
		varargs = append(varargs, a)
	}
	ret := m.ctrl.Call(m, "ListIntBlockFirstSeenByNode", varargs...)
	ret0, _ := ret[0].(*clickhouse.ListIntBlockFirstSeenByNodeResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListIntBlockFirstSeenByNode indicates an expected call of ListIntBlockFirstSeenByNode.
func (mr *MockXatuCBTClientMockRecorder) ListIntBlockFirstSeenByNode(ctx, in any, opts ...any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	varargs := append([]any{ctx, in}, opts...)
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListIntBlockFirstSeenByNode", reflect.TypeOf((*MockXatuCBTClient)(nil).ListIntBlockFirstSeenByNode), varargs...)
}
