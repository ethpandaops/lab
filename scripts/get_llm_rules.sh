...
#
# Usage:
#   ./scripts/get_llm_rules.sh [context_filter]
#
# Parameters:
#   context_filter - Optional: Only return rules matching this context (e.g., frontend, backend, api)
#
# Examples:
#   ./scripts/get_llm_rules.sh               # Return all rules
#   ./scripts/get_llm_rules.sh frontend      # Return only frontend rules
#   ./scripts/get_llm_rules.sh charts        # Return only chart-related rules

# Set variables
RULES_DIR="$(dirname "$(dirname "$0")")/llms/rules"
CONTEXT_FILTER="$1"
